    ...
    var content = {
        init: function(){
            ...
            for (var i = 0; i < $("#fwslider .slide").length; i++){
				...
				/* we set all the slider image in background because of it always show in center. Please remove it if yu don't want to need it or change it as per you requirement. */ 
				var src = $("#fwslider .slide:eq("+i+") img").attr('src');
				$("#fwslider .slide:eq("+i+")").css({
    	            'background': 'url(' + src + ') 50% 0'
	            });
				/* slide image background code end here. */
